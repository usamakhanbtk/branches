...
export const SchemasD = Yup.object({
    ...
    qualification:Yup.string().min(2,'Too Short').max(20).required('Please Enter Your Qualification'),
    opening:Yup.string().min(1,'Too Short').max(20).required('Please Enter Your opening time'),
    closing:Yup.string().min(1,'Too Short').max(20).required('Please Enter Your closing time'),
